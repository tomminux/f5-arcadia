  ...
  <body class="menu-position-side menu-side-left full-screen with-content-panel">
				  ...
				  <div class="os-tabs-w">
					<div class="os-tabs-controls os-tabs-complex" style="margin-bottom:15px">
						<ul class="nav nav-tabs" id="myTab" role="tablist">
						  <li class="nav-item">
							<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Credit Card Reference - Files</a>
						  </li>
	...
	<script>
		...
		$(document).on('click', '#delete_all', function(){
			...
			$("#home").html('<h4> Please Wait </h4> <img src ="img/loading_v2.gif" width=64 />');

		
			$.ajax({
				url: 'stored_cc_files.php?delete=yes',
				timeout:1500,
				type: 'GET',
				...
				error: function (data){
					$( "#home" ).html("<h4> App3 is not reachable </h4>");		
				}			
			});		
